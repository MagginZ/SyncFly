...
FlightVisualTuning tuningForPhase(FlightPhase phase, SessionSettings s) {
  ...
  return phase.when(
    ...
    taxiing: () => FlightVisualTuning(
      ...
      guidanceText: '滑行：视觉流向后下方滑移，像跑道加速前的视野',
      guidanceVisible: true,
    ...
    takeoffAcceleration: () => FlightVisualTuning(
      ...
      guidanceText: '加速推背：元素更强地向后、向下滑移（伪 3D 深度）',
      guidanceVisible: true,
      breathPattern: BreathPatternKind.fourSevenEight,
      hapticGain: 0.92,
    ),
    liftoffClimb: () => FlightVisualTuning(
      ...
      guidanceText: '拉起爬升：保持后下向流动，用 4-7-8 把注意放在呼吸',
      guidanceVisible: true,
      breathPattern: BreathPatternKind.fourSevenEight,
      hapticGain: 0.78,
    ),
    awaitingCruise: () => FlightVisualTuning(
      flowDirectionX: -0.06,
      flowDirectionY: 0.2,
      flowSpeed: 0.22 * rate,
      ...
      breathHz: 0.11 * rate,
      particleJitter: 0.03,
      guidanceText: '爬升将结束。若已感觉平稳，请点击「进入平飞」',
      guidanceVisible: true,
      breathPattern: BreathPatternKind.smoothSine,
      hapticGain: 0.45,
    ),
